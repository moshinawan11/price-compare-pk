...
class DarazProductDetailsScreen extends StatefulWidget {
  ...
  const DarazProductDetailsScreen(this.productURL, this.storeName);

  @override
  State<DarazProductDetailsScreen> createState() =>
      _DarazProductDetailsScreenState();
}

class _DarazProductDetailsScreenState extends State<DarazProductDetailsScreen> {
