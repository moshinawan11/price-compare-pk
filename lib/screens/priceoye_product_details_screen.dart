...
class PriceoyeProductDetailsScreen extends StatefulWidget {
  ...
  const PriceoyeProductDetailsScreen(this.productURL, this.storeName);

  @override
  State<PriceoyeProductDetailsScreen> createState() =>
      _PriceoyeProductDetailsScreenState();
}

class _PriceoyeProductDetailsScreenState
    extends State<PriceoyeProductDetailsScreen> {
  PriceoyeProduct? product;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SpecificationsWidget(specifications: product!.specifications),
          ],
        ),
      ),
      backgroundColor: Color.fromARGB(255, 8, 30, 65),
